...
public class BookController {
    ...
    public void getRegister(BookDTO dto, PageRequestDTO pageRequestDTO) { // Post에 BookDTO dto -> get에서도
        log.info("등록 화면 요청");
    }
    ...
    public void getRead(@RequestParam("id") Long id, PageRequestDTO pageRequestDTO, Model model) { // pk를 받아야 함
        log.info("도서 상세 조회 요청 {} {}", id, pageRequestDTO);
